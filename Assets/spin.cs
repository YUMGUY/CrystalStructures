...
// reference: https://www.youtube.com/watch?v=qbCEHCVx-Dc

public class spin : XRBaseInteractable
{
    [SerializeField] private Transform modelTransform;
    public UnityEvent<float> OnModelRotated;
    ...
    private void RotateWheel()
    {
        ...
        modelTransform.Rotate(transform.forward, -angleDifference, Space.World);

        // Store angle for next process
        currentAngle = totalAngle;
        OnModelRotated?.Invoke(angleDifference);
    }
